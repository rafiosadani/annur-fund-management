<div class="modal fade" id="detail-role-modal-form{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Detail Data Role</h6>
                    ...
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-12 col-lg-12">
                                ...
                                <input type="text" name="name" id="name" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ old('name', $role->name) }}" disabled />
                                @error('name')
                        ...
                        <div class="row mt-3">
                            ...
                            <hr class="horizontal dark my-lg-2 my-1">
                            <div class="col-12 col-lg-12">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="form-check form-switch d-inline-block align-middle">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    {{ $role->permissions->contains('id', $permission->id) ? "checked" : "" }} disabled
                                                                >
                                                            </div>
                                                        </td>
                                                    @endforeach
