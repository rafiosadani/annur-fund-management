                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Pemasukan Umum</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        @currency($data['totalInfaq'])
                                    </h5>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Pengeluaran Umum</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        @currency($data['totalGeneralExpenses'])
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Saldo Akhir</p>
                                    <h5 class="font-weight-bolder mb-0">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Pemasukan Program</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        @currency($data['totalDonations'])
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Pengeluaran Program</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        @currency($data['totalProgramExpenses'])
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Sisa Donasi</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        @currency($data['remainingDonations'])
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Donasi Program</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        @currency($data['totalDonorDonations'])
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Jumlah Program</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        {{ $data['countProgramDonation'] }}
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                    ...
                    <div class="card-body px-0 pt-0 pb-4">
                        <div class="table-responsive pt-0 px-4">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                @if($data['donorDonations']->total() < 1)
                                ...
                                @else
                                    @foreach($data['donorDonations'] as $donorDonation)
                                        <tr style="border-bottom: 1px solid #ccdddd;">
                                            <td>
                                                <p class="text-center text-xs mb-0">{{ $loop->iteration + ($data['donorDonations']->currentPage() - 1) * $data['donorDonations']->perPage() }}</p>
                                            </td>
                                            <td>
