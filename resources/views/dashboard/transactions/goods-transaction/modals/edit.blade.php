<div class="modal fade" id="edit-good-donation-modal-form-{{ $goodDonation->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form role="form" action="{{ route('good-donations.update', $goodDonation) }}" method="post">
                @csrf
                @method('put')
                                ...
                                <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="m_good_inventory_id"
                                                ...
                                                @foreach($goods as $good)
                                                    @if(old('m_good_inventory_id', $goodDonation->m_good_inventory_id) == $good->id)
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <select name="m_user_id"
                                                ...
                                                @foreach($users as $user)
                                                    @if(old('m_user_id',$goodDonation->m_user_id) == $user->id)
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('quantity') is-invalid @enderror inputNumberOnly" placeholder="Jumlah" name="quantity" value="{{ old('quantity', $goodDonation->quantity) }}">
                                            @error('quantity')
                                            <div class="invalid-feedback text-xxs ms-1">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <textarea style="resize: none;" class="form-control form-control-sm @error('note') is-invalid @enderror"
                                                      id="note" name="note" rows="3" >{{ old('note', $goodDonation->note) }}</textarea>
                                            @error('note')
                                            <div class="invalid-feedback text-xxs ms-1">
                                                {{ $message }}
                                            </div>
