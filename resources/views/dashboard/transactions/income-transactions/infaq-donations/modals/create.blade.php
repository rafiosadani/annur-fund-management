<div class="modal fade" id="create-infaq-donation-modal-form" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Transaksi Dana Infaq</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form role="form" action="{{ route('transaction.infaq-donations.store') }}" method="post">
                @csrf
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" placeholder="Nama Infaq" name="name" value="{{ old('name') }}">
                                            @error('name')
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <select name="m_infaq_type_id"
                                                ...
                                                @foreach($infaqTypes as $infaqType)
                                                    @if(old('m_infaq_type_id') == $infaqType->id)
